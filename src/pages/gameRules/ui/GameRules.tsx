    ...
    <div className="container mx-auto p-6 max-w-2xl">
      <div className="space-y-7 p-5 border border-border rounded-xl text-lg">
        ...
        <div className="space-y-4">
          ...
          <p>
            Представьте что вам представилась возможность управлять черной дырой. Ваша задача за
            максимально короткое время поглотить все планеты в вашей звёздной системе.
          </p>
        </div>
