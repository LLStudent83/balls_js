...
import { type RegisterDto, type UserResponseDto, useAuthControllerRegister } from 'shared/api';
...
export function AuthPage() {
  ...
  const errorAuthHandler = (e: unknown) => {
  ...
  return (
    <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] lg:w-1/3 sm:w-1/2 ">
      <div className="flex items-center justify-center gap-2 mb-3">
        <p>Если зарегистрированы </p> <Button onClick={redirectToLoginPageHandler}>Войдите</Button>
      </div>
